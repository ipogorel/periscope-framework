...
System.register(['./authorization/permissions-custom-attribute', './authorization/permissions-manager', './authorization/role-provider', './cache/cache-manager', './cache/cache-storage', './cache/memory-cache-storage', './config/dashboard-configuration', './data/data-holder', './data/data-source', './data/query', './data/query-expression-evaluator', './data/ast/parsers/ast-parser', './data/ast/parsers/ast-to-javascript-parser', './data/schema/schema-object', './data/schema/providers/schema-provider', './data/schema/providers/static-schema-provider', './data/schema/providers/swagger-schema-provider', './data/service/data-service', './data/service/json-data-service', './data/service/static-json-data-service', './dsl/grammar/grammar-expression', './dsl/grammar/grammar-tree', './dsl/grammar/grammar', './dsl/intellisence-manager', './dsl/parser', './helpers/converters/value-format', './helpers/data-helper', './helpers/guid-helper', './helpers/string-helper', './helpers/url-helper', './http/default-http-client', './infrastructure/dashboard-manager', './infrastructure/factory', './layout/dashboards/dashboard-base', './layout/widgets/widget', './layout/widgets/data-source-configurator', './layout/widgets/detailed-view', './layout/widgets/grid', './layout/widgets/chart', './layout/widgets/search-box', './navigator/navigation-history', './navigator/history-step', './navigator/dashboardbehavior/change-route-behavior', './navigator/dashboardbehavior/create-widget-behavior', './navigator/dashboardbehavior/dashboard-behavior', './navigator/dashboardbehavior/manage-navigation-stack-behavior', './navigator/dashboardbehavior/replace-widget-behavior', './navigator/events/widget-event-message', './navigator/events/widget-event', './navigator/widgetbehavior/widget-behavior', './navigator/widgetbehavior/data-activated-behavior', './navigator/widgetbehavior/data-field-selected-behavior', './navigator/widgetbehavior/data-filter-changed-behavior', './navigator/widgetbehavior/data-filter-handle-behavior', './navigator/widgetbehavior/data-selected-behavior', './navigator/widgetbehavior/data-source-changed-behavior', './navigator/widgetbehavior/data-source-handle-behavior', './navigator/widgetbehavior/settings-handle-behavior', './state/state-discriminator', './state/state-url-parser', './state/storage', './state/user-state-storage'], function (_export, _context) {
  return {
    setters: [function (_authorizationPermissionsCustomAttribute) {
      ...
      for (var _key31 in _httpDefaultHttpClient) {
        if (_key31 !== "default") _exportObj31[_key31] = _httpDefaultHttpClient[_key31];
      }
      ...
      for (var _key32 in _infrastructureDashboardManager) {
        if (_key32 !== "default") _exportObj32[_key32] = _infrastructureDashboardManager[_key32];
      }
      ...
      for (var _key51 in _navigatorWidgetbehaviorDataActivatedBehavior) {
        if (_key51 !== "default") _exportObj51[_key51] = _navigatorWidgetbehaviorDataActivatedBehavior[_key51];
      }
      ...
      for (var _key52 in _navigatorWidgetbehaviorDataFieldSelectedBehavior) {
        if (_key52 !== "default") _exportObj52[_key52] = _navigatorWidgetbehaviorDataFieldSelectedBehavior[_key52];
      }
      ...
      for (var _key53 in _navigatorWidgetbehaviorDataFilterChangedBehavior) {
        if (_key53 !== "default") _exportObj53[_key53] = _navigatorWidgetbehaviorDataFilterChangedBehavior[_key53];
      }
      ...
      for (var _key54 in _navigatorWidgetbehaviorDataFilterHandleBehavior) {
        if (_key54 !== "default") _exportObj54[_key54] = _navigatorWidgetbehaviorDataFilterHandleBehavior[_key54];
      }
      ...
      for (var _key55 in _navigatorWidgetbehaviorDataSelectedBehavior) {
        if (_key55 !== "default") _exportObj55[_key55] = _navigatorWidgetbehaviorDataSelectedBehavior[_key55];
      }
      ...
      for (var _key56 in _navigatorWidgetbehaviorDataSourceChangedBehavior) {
        if (_key56 !== "default") _exportObj56[_key56] = _navigatorWidgetbehaviorDataSourceChangedBehavior[_key56];
      }
      ...
      for (var _key57 in _navigatorWidgetbehaviorDataSourceHandleBehavior) {
        if (_key57 !== "default") _exportObj57[_key57] = _navigatorWidgetbehaviorDataSourceHandleBehavior[_key57];
      }
      ...
      for (var _key58 in _navigatorWidgetbehaviorSettingsHandleBehavior) {
        if (_key58 !== "default") _exportObj58[_key58] = _navigatorWidgetbehaviorSettingsHandleBehavior[_key58];
      }
      ...
      for (var _key59 in _stateStateDiscriminator) {
        if (_key59 !== "default") _exportObj59[_key59] = _stateStateDiscriminator[_key59];
      }
      ...
      for (var _key60 in _stateStateUrlParser) {
        if (_key60 !== "default") _exportObj60[_key60] = _stateStateUrlParser[_key60];
      }
      ...
      for (var _key61 in _stateStorage) {
        if (_key61 !== "default") _exportObj61[_key61] = _stateStorage[_key61];
      }
      ...
      for (var _key62 in _stateUserStateStorage) {
        if (_key62 !== "default") _exportObj62[_key62] = _stateUserStateStorage[_key62];
      }
