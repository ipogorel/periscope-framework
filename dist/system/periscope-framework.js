...
System.register(['lodash', 'pegjs', 'numeral', 'moment', 'aurelia-framework', 'aurelia-fetch-client', 'aurelia-event-aggregator', 'aurelia-router', 'swagger-client'], function (_export, _context) {
  var _, peg, numeral, moment, inject, resolver, transient, HttpClient, EventAggregator, Router, Swagger, _typeof, _dec, _class, _dec2, _class2, _dec3, _class3, _class4, _dec4, _class5, _dec5, _dec6, _class6, _dec7, _dec8, _class7, _createClass, CacheManager, CacheStorage, MemoryCacheStorage, DashboardConfiguration, DataHolder, Datasource, DataSourceConfiguration, QueryExpressionEvaluator, Query, DslExpressionManagerFactory, DslExpressionManager, ExpressionParserFactory, ExpressionParser, DSL_GRAMMAR, Grammar, DataHelper, GuidHelper, StringHelper, UrlHelper, NavigationHistory, PeriscopeRouter, DashboardManager, Factory, StateDiscriminator, StateUrlParser, Storage, STORAGE_KEY, UserStateStorage, Schema, DataService, DataServiceConfiguration, JsonDataService, StaticJsonDataService, FormatValueConverter, ChangeRouteBehavior, CreateWidgetBehavior, DashboardBehavior, ManageNavigationStackBehavior, ReplaceWidgetBehavior, WidgetEventMessage, WidgetEvent, DataActivatedBehavior, DataFieldSelectedBehavior, DataFilterChangedBehavior, DataFilterHandleBehavior, DataSelectedBehavior, DataSourceChangedBehavior, DataSourceHandleBehavior, SettingsHandleBehavior, WidgetBehavior, SchemaProvider, StaticSchemaProvider, SwaggerSchemaProvider;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('PeriscopeRouter', PeriscopeRouter = (_dec3 = inject(Router, EventAggregator, UserStateStorage, NavigationHistory, StateUrlParser), _dec3(_class3 = function () {
      ...
      _export('Factory', Factory = resolver(_class4 = function () {
      ...
      _export('UserStateStorage', UserStateStorage = (_dec4 = inject(Storage), _dec4(_class5 = function () {
