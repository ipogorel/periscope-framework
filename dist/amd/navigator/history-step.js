define(['exports', 'aurelia-framework', 'lodash', './../infrastructure/dashboard-manager', './navigation-history', './../state/state-discriminator', './../state/state-url-parser', './../helpers/string-helper'], function (exports, _aureliaFramework, _lodash, _dashboardManager, _navigationHistory, _stateDiscriminator, _stateUrlParser, _stringHelper) {
  'use strict';
