...
System.register(['lodash', 'numeral', 'moment', 'pegjs', 'aurelia-framework', 'aurelia-fetch-client', 'aurelia-event-aggregator', 'aurelia-router', 'swagger-client'], function (_export, _context) {
  var lodash, _, numeral, moment, peg, computedFrom, resolver, customElement, inject, useView, Decorators, bindable, noView, transient, HttpClient, EventAggregator, Router, Swagger, _typeof, _dec, _desc, _value, _class, _class2, _dec2, _dec3, _class3, _dec4, _class4, _dec5, _dec6, _class5, _dec7, _class6, _dec8, _class7, _dec9, _class8, _createClass, SchemaProvider, WidgetBehavior, WidgetEvent, WidgetEventMessage, DashboardBehavior, Widget, DashboardBase, LayoutWidget, DataService, DataServiceConfiguration, Schema, NavigationHistory, Storage, StateDiscriminator, Factory, DashboardManager, UrlHelper, StringHelper, GuidHelper, DataHelper, QueryExpressionEvaluator, DataHolder, DSL_GRAMMAR, Grammar, ExpressionParser, DashboardConfiguration, CacheStorage, CacheManager, StaticSchemaProvider, DataFilterHandleBehavior, DataSourceHandleBehavior, SettingsHandleBehavior, DataActivatedBehavior, DataFieldSelectedBehavior, DataFilterChangedBehavior, DataSelectedBehavior, DataSourceChangedBehavior, ChangeRouteBehavior, CreateWidgetBehavior, ManageNavigationStackBehavior, ReplaceWidgetBehavior, Chart, DataSourceConfigurator, DetailedView, Grid, SearchBox, JsonDataService, SwaggerSchemaProvider, STORAGE_KEY, UserStateStorage, StateUrlParser, Query, FormatValueConverter, StaticJsonDataService, Datasource, DataSourceConfiguration, ExpressionParserFactory, MemoryCacheStorage, PeriscopeRouter, DslExpressionManager, DslExpressionManagerFactory;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('ExpressionParserFactory', ExpressionParserFactory = (_dec7 = inject(HttpClient), _dec7(_class6 = function () {
