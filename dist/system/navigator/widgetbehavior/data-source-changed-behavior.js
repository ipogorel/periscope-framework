...
System.register(['./broadcaster-behavior', '../events/widget-event-message', 'aurelia-event-aggregator', 'aurelia-framework'], function (_export, _context) {
  ...
  var BroadcasterBehavior, WidgetEventMessage, EventAggregator, inject, _dec, _class, DataSourceChangedBehavior;
  ...
  return {
    ...
    execute: function () {
      _export('DataSourceChangedBehavior', DataSourceChangedBehavior = (_dec = inject(EventAggregator), _dec(_class = function (_BroadcasterBehavior) {
