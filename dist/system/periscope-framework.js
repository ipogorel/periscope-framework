...
System.register(['lodash', 'numeral', 'moment', 'pegjs', 'aurelia-framework', 'aurelia-fetch-client', 'aurelia-event-aggregator', 'aurelia-router', 'swagger-client'], function (_export, _context) {
  var lodash, _, numeral, moment, peg, computedFrom, resolver, customElement, inject, useView, Decorators, bindable, noView, transient, HttpClient, EventAggregator, Router, Swagger, _typeof, _dec, _desc, _value, _class, _class2, _dec2, _dec3, _class3, _dec4, _class4, _dec5, _class5, _dec6, _dec7, _class6, _dec8, _class7, _dec9, _class8, _createClass, SchemaProvider, WidgetBehavior, WidgetEvent, WidgetEventMessage, DashboardBehavior, Widget, DashboardBase, LayoutWidget, DataService, DataServiceConfiguration, Schema, Storage, StateDiscriminator, NavigationHistory, Factory, DashboardManager, UrlHelper, StringHelper, GuidHelper, DataHelper, DSL_GRAMMAR, Grammar, ExpressionParser, QueryExpressionEvaluator, DataHolder, DashboardConfiguration, CacheStorage, CacheManager, StaticSchemaProvider, DataFilterHandleBehavior, DataSourceHandleBehavior, SettingsHandleBehavior, DataActivatedBehavior, DataFieldSelectedBehavior, DataFilterChangedBehavior, DataSelectedBehavior, DataSourceChangedBehavior, ChangeRouteBehavior, CreateWidgetBehavior, ManageNavigationStackBehavior, ReplaceWidgetBehavior, Chart, DataSourceConfigurator, DetailedView, Grid, SearchBox, JsonDataService, SwaggerSchemaProvider, STORAGE_KEY, UserStateStorage, StateUrlParser, Query, FormatValueConverter, ExpressionParserFactory, StaticJsonDataService, Datasource, DataSourceConfiguration, MemoryCacheStorage, PeriscopeRouter, DslExpressionManager, DslExpressionManagerFactory;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('DataSourceConfigurator', DataSourceConfigurator = function (_Widget2) {
      ...
      _export('DetailedView', DetailedView = function (_Widget3) {
