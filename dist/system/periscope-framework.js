...
System.register(['lodash', 'pegjs', 'numeral', 'moment', 'aurelia-framework', 'aurelia-fetch-client', 'aurelia-event-aggregator', 'aurelia-router', 'swagger-client'], function (_export, _context) {
  var lodash, _, peg, numeral, moment, computedFrom, resolver, customElement, inject, useView, Decorators, bindable, noView, transient, HttpClient, EventAggregator, Router, Swagger, _typeof, _dec, _desc, _value, _class, _class2, _dec2, _dec3, _class3, _dec4, _class4, _dec5, _class5, _dec6, _dec7, _class6, _dec8, _class7, _dec9, _class8, _createClass, SchemaProvider, Widget, DashboardBase, LayoutWidget, WidgetBehavior, WidgetEvent, WidgetEventMessage, DashboardBehavior, DataService, DataServiceConfiguration, Schema, Storage, StateDiscriminator, NavigationHistory, Factory, DashboardManager, DSL_GRAMMAR, Grammar, ExpressionParser, QueryExpressionEvaluator, DataHolder, UrlHelper, StringHelper, GuidHelper, DataHelper, DashboardConfiguration, CacheStorage, CacheManager, StaticSchemaProvider, Chart, DetailedView, DataFilterHandleBehavior, DataSourceHandleBehavior, SettingsHandleBehavior, DataSourceConfigurator, Grid, SearchBox, DataActivatedBehavior, DataFieldSelectedBehavior, DataFilterChangedBehavior, DataSelectedBehavior, DataSourceChangedBehavior, ChangeRouteBehavior, CreateWidgetBehavior, ManageNavigationStackBehavior, ReplaceWidgetBehavior, JsonDataService, SwaggerSchemaProvider, STORAGE_KEY, UserStateStorage, ExpressionParserFactory, Datasource, DataSourceConfiguration, StateUrlParser, Query, FormatValueConverter, StaticJsonDataService, MemoryCacheStorage, PeriscopeRouter, DslExpressionManager, DslExpressionManagerFactory;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('Factory', Factory = resolver(_class2 = function () {
      ...
      _export('Chart', Chart = function (_Widget) {
        ...
        function Chart(settings) {
          ...
          var _this6 = _possibleConstructorReturn(this, _Widget.call(this, settings));

          _this6.categoriesField = settings.categoriesField;
          _this6.seriesDefaults = settings.seriesDefaults;
          _this6.stateType = "chartState";
          _this6.attachBehaviors();
          return _this6;
        }
      ...
      _export('DetailedView', DetailedView = function (_Widget2) {
        _inherits(DetailedView, _Widget2);

        function DetailedView(settings) {
          _classCallCheck(this, DetailedView);

          var _this7 = _possibleConstructorReturn(this, _Widget2.call(this, settings));

          _this7.fields = settings.fields;
          _this7.stateType = "detailedViewState";
          _this7.attachBehaviors();
          return _this7;
        }
      ...
      _export('DataFilterHandleBehavior', DataFilterHandleBehavior = function (_WidgetBehavior) {
        ...
        function DataFilterHandleBehavior(channel, eventAggregator, filterMapper) {
          ...
          var _this8 = _possibleConstructorReturn(this, _WidgetBehavior.call(this));

          _this8._channel = channel;
          _this8._eventAggregator = eventAggregator;
          _this8._filterMapper = filterMapper;
          return _this8;
        }
      ...
      _export('DataSourceHandleBehavior', DataSourceHandleBehavior = function (_WidgetBehavior2) {
        ...
        function DataSourceHandleBehavior(channel, eventAggregator) {
          ...
          var _this9 = _possibleConstructorReturn(this, _WidgetBehavior2.call(this));

          _this9._channel = channel;
      ...
      _export('SettingsHandleBehavior', SettingsHandleBehavior = function (_WidgetBehavior3) {
        ...
        function SettingsHandleBehavior(channel, eventAggregator, messageMapper) {
          ...
          var _this10 = _possibleConstructorReturn(this, _WidgetBehavior3.call(this));

          _this10._channel = channel;
          _this10._eventAggregator = eventAggregator;
          _this10._messageMapper = messageMapper;
          return _this10;
        }
      ...
      _export('DataSourceConfigurator', DataSourceConfigurator = function (_Widget3) {
        _inherits(DataSourceConfigurator, _Widget3);

        function DataSourceConfigurator(settings) {
          _classCallCheck(this, DataSourceConfigurator);

          var _this11 = _possibleConstructorReturn(this, _Widget3.call(this, settings));

          _this11.dataSourceToConfigurate = settings.dataSourceToConfigurate;
          _this11.stateType = "dataSourceConfiguratorState";
          _this11._dataSourceChanged = new WidgetEvent();
          _this11.attachBehaviors();
          return _this11;
        }
      ...
      _export('Grid', Grid = function (_Widget4) {
        _inherits(Grid, _Widget4);

        function Grid(settings) {
          _classCallCheck(this, Grid);

          var _this12 = _possibleConstructorReturn(this, _Widget4.call(this, settings));

          _this12.columns = settings.columns ? settings.columns : [];
          _this12.navigatable = settings.navigatable;
          _this12.autoGenerateColumns = settings.autoGenerateColumns;
          _this12.pageSize = settings.pageSize;
          _this12.group = settings.group;

          _this12.stateType = "gridState";

          _this12._dataSelected = new WidgetEvent();
          _this12._dataActivated = new WidgetEvent();
          _this12._dataFieldSelected = new WidgetEvent();

          _this12.attachBehaviors();
          return _this12;
        }
      ...
      _export('SearchBox', SearchBox = function (_Widget5) {
        _inherits(SearchBox, _Widget5);

        function SearchBox(settings) {
          _classCallCheck(this, SearchBox);

          var _this13 = _possibleConstructorReturn(this, _Widget5.call(this, settings));

          _this13.stateType = "searchBoxState";
          _this13._dataFilterChanged = new WidgetEvent();
      ...
      _export('DataActivatedBehavior', DataActivatedBehavior = function (_WidgetBehavior4) {
        ...
        function DataActivatedBehavior(chanel, eventAggregator) {
          ...
          var _this14 = _possibleConstructorReturn(this, _WidgetBehavior4.call(this));
      ...
      _export('DataFieldSelectedBehavior', DataFieldSelectedBehavior = function (_WidgetBehavior5) {
        ...
        function DataFieldSelectedBehavior(chanel, eventAggregator) {
          ...
          var _this15 = _possibleConstructorReturn(this, _WidgetBehavior5.call(this));
      ...
      _export('DataFilterChangedBehavior', DataFilterChangedBehavior = function (_WidgetBehavior6) {
        ...
        function DataFilterChangedBehavior(channel, eventAggregator) {
          ...
          var _this16 = _possibleConstructorReturn(this, _WidgetBehavior6.call(this));

          _this16._channel = channel;
      ...
      _export('DataSelectedBehavior', DataSelectedBehavior = function (_WidgetBehavior7) {
        ...
        function DataSelectedBehavior(chanel, eventAggregator) {
          ...
          var _this17 = _possibleConstructorReturn(this, _WidgetBehavior7.call(this));
      ...
      _export('DataSourceChangedBehavior', DataSourceChangedBehavior = function (_WidgetBehavior8) {
        ...
        function DataSourceChangedBehavior(channel, eventAggregator) {
          ...
          var _this18 = _possibleConstructorReturn(this, _WidgetBehavior8.call(this));
      ...
      _export('JsonDataService', JsonDataService = (_dec2 = transient(), _dec3 = inject(HttpClient), _dec2(_class3 = _dec3(_class3 = function (_DataService) {
      ...
      _export('UserStateStorage', UserStateStorage = (_dec4 = inject(Storage), _dec4(_class4 = function () {
      ...
      _export('ExpressionParserFactory', ExpressionParserFactory = (_dec5 = inject(HttpClient), _dec5(_class5 = function () {
      ...
      _export('Datasource', Datasource = function () {
        ...
        Datasource.prototype.getData = function getData(query) {
          ...
          return this.transport.readService.read({
            ...
            if (storage) storage.setItem(cacheKey, { data: dataHolder.data, total: dataHolder.total }, _this27._cache.cacheTimeSeconds);
            return dataHolder;
          });
        };
      ...
      _export('StaticJsonDataService', StaticJsonDataService = (_dec6 = transient(), _dec7 = inject(HttpClient), _dec6(_class6 = _dec7(_class6 = function (_DataService2) {
        ...
        function StaticJsonDataService(http) {
          ...
          var _this28 = _possibleConstructorReturn(this, _DataService2.call(this));
        ...
        StaticJsonDataService.prototype.read = function read(options) {
          ...
          return this._http.fetch(this.url).then(function (response) {
            ...
            var d = jsonData;
            d = _this29.dataMapper ? _this29.dataMapper(d) : d;
            if (options.filter) {
            ...
            return {
              ...
              total: _this29.totalMapper ? _this29.totalMapper(jsonData) : total
            };
          });
        };
      ...
      _export('PeriscopeRouter', PeriscopeRouter = (_dec8 = inject(Router, EventAggregator, UserStateStorage, NavigationHistory, StateUrlParser), _dec8(_class7 = function () {
      ...
      _export('DslExpressionManagerFactory', DslExpressionManagerFactory = (_dec9 = inject(ExpressionParserFactory), _dec9(_class8 = function () {
