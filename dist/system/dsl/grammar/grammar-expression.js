...
System.register(['./grammar', './../../helpers/data-helper'], function (_export, _context) {
  var Grammar, DataHelper, DSL_GRAMMAR_EXPRESSION, GrammarExpression;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('GrammarExpression', GrammarExpression);
    }
  };
});