define(['exports', 'aurelia-framework', 'aurelia-event-aggregator', 'aurelia-router', './navigation-history', './../state/user-state-storage', './../state/state-discriminator', './../state/state-url-parser', './../helpers/string-helper', 'lodash'], function (exports, _aureliaFramework, _aureliaEventAggregator, _aureliaRouter, _navigationHistory, _userStateStorage, _stateDiscriminator, _stateUrlParser, _stringHelper, _lodash) {
  'use strict';
